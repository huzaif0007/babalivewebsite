  ...
  render() {
    return (
      <div className='container my-3'>
        <h1 className='text-center, text-bold' style={{ margin: '35px 0px', marginTop: '90px' }}> NewsMonkey- Top headlines for {this.capitalizeFirstletter(this.props.category)} Headlines </h1>
